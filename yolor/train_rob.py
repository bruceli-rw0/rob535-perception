...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        #--------------------------------------------------------------------------------------------------------------#
        logger.info(f'Start in-training evaluation for epoch {epoch+1}...')

        final_epoch = epoch + 1 == epochs
        val_accuracy, maps, times = test_rob.test(
            opt.data,
        ...
        with open(wdir / 'val_accuracy.txt', 'a') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights',        type=str, default='weights/yolor_csp_x_star.pt', help='initial weights path')
    ...
    parser.add_argument('--img-size',       type=int, nargs='+', default=[1280, 1280], help='[train, test] image sizes')
    ...
    # use local time as folder name
    opt.name = time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime())
